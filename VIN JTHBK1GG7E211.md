...
(function (d, w, c) { (w\[c\] = w\[c\] || \[\]).push(function() { try { w.yaCounter48906998 = new Ya.Metrika({ id:48906998, clickmap:true, trackLinks:true, accurateTrackBounce:true, webvisor:true }); } catch(e) { } }); var n = d.getElementsByTagName("script")\[0\], s = d.createElement("script"), f = function () { n.parentNode.insertBefore(s, n); }; s.type = "text/javascript"; s.async = true; s.src = "https://mc.yandex.ru/metrika/watch.js"; if (w.opera == "\[object Opera\]") { d.addEventListener("DOMContentLoaded", f, false); } else { f(); } })(document, window, "yandex\_metrika\_callbacks");

![](https://mc.yandex.ru/watch/48906998)

  window.decovin\_ajax = { ajax\_url: 'https://vincheck.me/wp-admin/admin-ajax.php', nonce: 'c211315993' };
